  ...
  useEffect(() => {
    const fetchAtividades = async () => {
      try {
        ...
        const response = await axios.get('http://127.0.0.1:8000/exercicio/status-da-lista-exercicio/', {
          headers: {
